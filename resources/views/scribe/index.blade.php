...
<head>
    ...
    <title>Larasonic Documentation</title>
    ...
    <script>
        var tryItOutBaseUrl = "http://localhost:8010";
        var useCsrf = Boolean();
...
<p>This is the API docs example for the Larasonic app.</p>
<aside>
    <strong>Base URL</strong>: <code>http://localhost:8010</code>
</aside>
